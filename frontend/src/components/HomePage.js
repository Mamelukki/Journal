...
import cherrytree from '../images/flowers.jpg'
import flatlay from '../images/cherrytree.jpg'
import {
  Link
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gridGap: '25px' }}>
        <div style={{ position: 'relative' }}>
          ...
          <div style={{ fontSize: 'x-large', position: 'absolute', color: 'black', top: '0', display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '100%', textAlign: 'center', paddingLeft: '15%', paddingRight: '15%' }}>
            <p>Ever dreamed of an online journal? We got you! In this journal, you can give the day a title, describe your day and your feelings and add up to 10 images per entry to bring your journal entries to life! <strong>Happy journaling!</strong></p>
          </div>
        </div>
        <div style={{ position: 'relative' }}>
          <p style={{ backgroundImage: `url(${flatlay})`, height: '600px', maxWidth: '100%', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }} />
          <div style={{ fontSize: 'x-large', position: 'absolute', color: 'black', top: '0', display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '100%', textAlign: 'center', paddingLeft: '15%', paddingRight: '15%' }}>
